package net.rom95.manifesto.backend.io;
...
public class FileUtility {
	 ...
	 * @return
	 */
	public boolean hasExtension(String file, String extension) {
	 ...
	 * @return
	 */
	public long getLastModifiedDate(File file) {
	 ...
	 * @throws IOException
	 */
	public String convertInputStreamToString(final InputStream in) throws IOException {
	 ...
	 */
	public File[] convertFileCollectionToFileArray(final Collection<File> files) {
	 ...
	 * @since 2.2
	 */
	public boolean contentEqualsIgnoreEOL(final File file1, final File file2, final String charsetName)
			throws IOException {
		final boolean file1Exists = file1.exists();
		if (file1Exists != file2.exists()) {
			return false;
	 ...
	 */
	public boolean isFileNewer(final File file, final Date date) {
		if (date == null) {
	 ...
	 * @throws IllegalArgumentException if the file is {@code null}
	 */
	public boolean isFileNewer(final File file, final long timeMillis) {
		if (file == null) {
	 ...
	 * @return
	 */
	public String join(String file, String ext) {
		return file + '/' + ext;
	}
	 ...
	 */
	public boolean move(File oldf, File newf) {
	 ...
	 */
	public List<File> getFileList(File d) {
	 ...
	 * @return a list of directory contents
	 */
	public List<File> getFileList(File d, int depth) {
	 ...
	 */
	public boolean forceDeletePath(File path) {
		if (path == null) {
			return false;
		}
